...
class RoarmDriver(Node):
    ...
    def __init__(self):
        super().__init__('batrobot_driver')
    ...
    def joint_states_callback(self, msg):
        ...
        base = -position[name.index('joint_1')]
        shoulder = -position[name.index('joint_2')]
        elbow = position[name.index('joint_3')]
        elbow_hand = position[name.index('joint_4')] 
        hand =  3.1415926 - position[name.index('joint_5')]
